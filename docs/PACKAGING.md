...
| **安卓** | `dist-android/BambuMonitor-1.0.1-arm64.apk`（约 33 MB） | `android/build-apk.ps1` | Android 7.0+（arm64） |
...
```
BambuMonitor-cli.exe --version    → Bambu Monitor 1.0.1（管道/重定向均可捕获）
